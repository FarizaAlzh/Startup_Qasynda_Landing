document.addEventListener("DOMContentLoaded", function () {
    ...
    const textElements = {
        ...
        "team1": {
            "ru": "Вдохновитель Qasynda и человек…",
            "en": "Qasynda's inspiration and the person..."
        },
        "team2": {
            "ru": "PR-Manager, мастер общения и продвижения…",
            "en": "PR-Manager, master of communication and promotion…   "
        },
        "team3": {
            "ru": "Product-Manager, следит за удобством платформы…",
            "en": "Product Manager, monitors the usability of the platform…"
        },
        "team4": {
            "ru": "Software Engineer, превращает идеи в реальность…",
            "en": "Software Engineer, turns ideas into reality…"
        },
        "contact-title": {
            "ru": "Свяжитесь с нами",
            "en": "Contact Us"
